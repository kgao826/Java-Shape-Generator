 ...
 *	The Assignement took me about 3 weeks (non-continuous)
 *	Drawing shapes was easy however the QuadCircle intersect was pretty hard, I finnaly found a solution on the Java Documentation.
 * 	Mainly the classes implementation such as abstract method, protected variables etc.
 *	============================================================================================
 */
import javax.swing.*;
import java.awt.*;
...
public class A1 extends JFrame {
	...
	public A1() {
		...
		* @return toolsPanel		the Panel
		...
		shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {recangletButtonIcon,squareButtonIcon,ellipseButtonIcon,circleButtonIcon,quadcirclesButtonIcon,pixelArtButtonIcon } );
