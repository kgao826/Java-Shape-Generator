...
public class AnimationPanel extends JComponent implements Runnable {
	...
	protected void createNewShape(int x, int y) {
		...
		switch (currentShapeType) { //complete this
			case 0:
				MovingShape rectangle = new MovingRectangle(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(rectangle);
				break;
			case 1:
				MovingShape square = new MovingSquare(x, y, Math.min(currentWidth, currentHeight), marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(square);
				break;
			case 2:
				MovingShape ellipse = new MovingEllipse(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(ellipse);
				break;
			case 3:
				MovingShape circle = new MovingCircle(x, y, Math.min(currentWidth, currentHeight), marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(circle);
				break;		
			case 4:
				MovingShape quadCircle = new MovingQuadCircles(x, y, Math.min(currentWidth, currentHeight), marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(quadCircle);
				break;
			case 5:
				MovingShape pixelArt = new MovingPixelArt(x, y, Math.min(currentWidth, currentHeight), marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath);
				shapes.add(pixelArt);
				break;
		}
	}
	...
	public String getSortedInfo() {
		public String getSortedInfo() {
			String result = "";
			Collections.sort(shapes, (currentShape, otherShape) -> currentShape.compareTo(otherShape));
